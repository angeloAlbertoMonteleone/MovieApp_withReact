    ...
    <div className={styles.Container}>
        ...
        <div className={styles.movies}>
            {movies.length > 0 && movies.map((movie) => {
                return <div className={styles.movie}><Card className={styles.Card} data={movie} key={movie.id} {...movie}></Card></div> 
            })}
        </div>
        
        <div id="transparent_div_left"></div>
        <div id="transparent_div_right"></div>
